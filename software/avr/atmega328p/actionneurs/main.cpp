...
//     
    ...
    // RESET DE L'AX12
//     serial_t_::print((char)(0xFF));
//     serial_t_::print((char)0x49);
//     serial_t_::print((char)0xFE);
//     serial_t_::print((char)0x02);
//     serial_t_::print((char)0x06);            
//     serial_t_::print((char)(~(0xfe + 0x02 + 0x06)&masque));
    
    // BAUD RATE à 9600
    serial_t_::print((char)0xFF);
    serial_t_::print((char)0xFF);
    serial_t_::print((char)0xFE);
    serial_t_::print((char)0x03);
    serial_t_::print((char)0x04);
    serial_t_::print((char)0xCF);
    serial_t_::print((char)(~(0xfe + 0x03 + 0x04 + 0xCF)&masque));
    ...
    serial_t_::print((char)0xFE);
    serial_t_::print((char)0x03);
    serial_t_::print((char)24);
    serial_t_::print((char)0x01);
    serial_t_::print((char)(~(0xfe + 0x03 + 24 + 0x01)&masque));
    
    // ROTATION
    serial_t_::print((char)0xFF);
    serial_t_::print((char)0xFF);
    serial_t_::print((char)0x01);
    serial_t_::print((char)0x07);
    serial_t_::print((char)0x03);
    serial_t_::print((char)0x1E);
    serial_t_::print((char)0x12);
    serial_t_::print((char)0x02);
    serial_t_::print((char)0x00);
    serial_t_::print((char)0x02);
    serial_t_::print((char)(~(0x01 + 0x07 + 0x03 + 0x1E + 0x12 + 0x02 + 0x00 + 0x02)&masque));
    ...
    serial_t_::print((char)0xFE);
    serial_t_::print((char)0x02);
    serial_t_::print((char)0x05);
    serial_t_::print((char)0xFA);
    ...
    while (1)
    {
        ...
        serial_t_::print((char)0x05);
        serial_t_::print((char)0x03);
        serial_t_::print((char)0x18);
        serial_t_::print((char)0x01);
        serial_t_::print((char)0x01);
        serial_t_::print((char)(~(0xfe + 0x05 + 0x03 + 0x01 + 0x01 + 0x18)&masque));
    }
