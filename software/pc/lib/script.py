...
class Script:
    ...
    def defendreBase(self):
     ...
     def collecte_sud(self):
         """
         Collecte les disques et lingots du sud de la map
         """
        self.asserInstance.goTo(outils_math.point.Point(705, 265))
        self.actionInstance.deplacer(110)
        self.asserInstance.tourner(2.09)
        self.asserInstance.avancer(80.0)
        self.asserInstance.tourner(2.112)
        self.asserInstance.avancer(145.0)
        self.asserInstance.tourner(2.939)
        self.asserInstance.avancer(173.0)
        self.asserInstance.tourner(3.078)
        self.asserInstance.avancer(390.0)
        self.asserInstance.tourner(-3.141)
        self.asserInstance.avancer(165.0)
        self.asserInstance.tourner(-3.094)
        self.asserInstance.avancer(210.0)
        self.asserInstance.tourner(-2.934)
        self.asserInstance.avancer(194.0)
        self.actionInstance.deplacer(70)
        self.asserInstance.tourner(0.282)
        self.actionInstance.deplacer(110)
        self.asserInstance.avancer(1764.0)
        self.asserInstance.avancer(-200)
