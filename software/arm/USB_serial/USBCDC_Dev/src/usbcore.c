...
//                case AUDIO_REQUEST_SET_RES:
              ...
              if ((SetupPacket.wIndex.WB.L == USB_CDC_CIF_NUM0)  ||       /* IF number correct? */
            	  ...
            	  (SetupPacket.wIndex.WB.L == USB_CDC_CIF_NUM2)  ||
            	  (SetupPacket.wIndex.WB.L == USB_CDC_DIF_NUM2)  ||
            	  (SetupPacket.wIndex.WB.L == USB_CDC_CIF_NUM3)  ||
            	  (SetupPacket.wIndex.WB.L == USB_CDC_DIF_NUM3)  ||
            	  (SetupPacket.wIndex.WB.L == USB_CDC_CIF_NUM4)  ||
            	  (SetupPacket.wIndex.WB.L == USB_CDC_DIF_NUM4)) {
